<!--https://github.com/HosseinShabani/svelte-checkbox-->
<script lang="typescript">
    ...
    export { checked, required, size, name, id, primaryColor, secondaryColor, duration, labelId };
  </script>
  ...
  <div
    ...
    <input {required} id={labelId} type="checkbox" on:change={handleChange} {name} />
